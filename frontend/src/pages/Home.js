...
const getEvent = async (EventTopic, EventABI) => {
  ...
  const responseEvents = await Moralis.EvmApi.events.getContractEvents(EventOptions);
  ...
  useEffect(() => {
      async function getProposals() {
        ...
        await Moralis.start({
          apiKey: "GeTBWkWgBzlAZet6dAsd93rvLLEcPW2itAE0uAjNZ5YDsl8fZvkjOojwBfTKgzPc",
  ...
  // * Getting ProposalCreated Event
    ...
    const Proposal_Created_Event_TOPIC = "0x3ec21697eb8018b62928e5f290d2bccf3af51e8b6cdf71fceab712977647bba9";
    const results = await getEvent(Proposal_Created_Event_TOPIC, Proposal_Created_Event_ABI)
